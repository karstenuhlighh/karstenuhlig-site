...
export const leadershipClasses: LeadershipClass[] = [
  {
    ...
    description: "Entscheidungen sollten dort fallen, wo fachliche Expertise und Verantwortung zusammenkommen.",
  ...
  },
  {
    ...
    managementQuestion: "Risiken sollten früh sichtbar werden und Wirkung offen besprochen werden. Bleibt sie hinter den Erwartungen zurück, ist für mich zuerst entscheidend, die Ursache zu verstehen und daraus den passenden nächsten Schritt abzuleiten.",
  ...
  },
  {
    ...
    managementQuestion: "Welche Prioritäten gelten und was warten muss, sollte für alle sichtbar sein.",
  ...
  },
  {
    ...
    description: "Viele Ergebnisse entstehen über Funktionen, Märkte und Verantwortungsbereiche hinweg. Gemeinsames Verständnis der Lage, transparente Interessen und verlässliche Zusagen schaffen dafür die Grundlage.",
  ...
  },
  {
    ...
    description: "Führung heißt für mich, Orientierung zu geben, Verantwortung klar zu verankern und für unterschiedliche Perspektiven offen zu bleiben. Eigene Einschätzungen gehören genauso auf den Prüfstand wie die anderer.",
