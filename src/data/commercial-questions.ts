...
export const commercialQuestions: CommercialQuestion[] = [
  ...
  },
  {
    ...
    field: {
      ...
      description: "Angebot, Journey und Wirtschaftlichkeit zusammenführen.",
  ...
  },
  {
    ...
    field: {
      ...
      managementQuestion: "Wie skaliere ich Commercial über Märkte, ohne den lokalen Kontext zu verlieren?",
